#!/usr/bin/env python3
"""
Fetch Historical Open Interest (OI) for Top 100 Coins since 2020
- Uses CoinMarketCap snapshots to select latest top 100 coins
...
def main():
    ...
    # Step 1: Top 100 coins by latest snapshot
    top_100 = get_top_n_coins(100)
    print("\nTop 100 Coins:")
    print("-" * 80)
    for coin in top_100[:20]:
    ...
    detailed_file = out_dir / f'historical_open_interest_top100_since2020_{timestamp}.csv'
    ...
    summary_file = out_dir / f'historical_open_interest_top100_since2020_summary_{timestamp}.csv'
