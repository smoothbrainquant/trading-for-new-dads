#!/usr/bin/env python3
"""
Fetch Historical Funding Rates for Top 100 Coins
...
def main():
    print("="*80)
    print("FETCH HISTORICAL FUNDING RATES - TOP 100 COINS")
    print("="*80)
    ...
    output_file = f'historical_funding_rates_top100_{timestamp}.csv'
    ...
    # Save summary
    summary_file = f'historical_funding_rates_top100_summary_{timestamp}.csv'
