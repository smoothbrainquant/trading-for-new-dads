...
def example_3_compare_modes():
    ...
    print("\n📊 Signal Comparison:")
    print(f"  Divergence longs that are Trend shorts: {div_long_set.intersection(set(trend_pos['shorts']))}")
    print(f"  Divergence shorts that are Trend longs: {set(div_pos['shorts']).intersection(trend_long_set)}")
